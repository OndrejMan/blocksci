    ...
    py::class_<CoinjoinClusterManager>(s, "CoinjoinClusterManager", "Class managing the cluster dat for coinjoins")
        ...
        .def_static(
            ...
            [](Blockchain &chain, BlockHeight start, BlockHeight stop,
               ...
               const std::string &coinjoinType, bool overwrite, int maxDistance,
               std::optional<uint64_t> minInputCount) {
                ...
                auto range = chain[{start, stop}];
                return CoinjoinClusterManager::createClustering(range, heuristicFunc, outputPath, coinjoinType,
                                                                overwrite, maxDistance, minInputCount);
            },
            py::arg("chain"), py::arg("start"), py::arg("stop"), py::arg("heuristic_func"), py::arg("output_path"),
            py::arg("coinjoin_type"), py::arg("overwrite") = false, py::arg("max_distance") = 2,
            ...
            "A coinjoin_type is required; the clustering is always seeded on CoinJoin transactions.\n"
            ...
            "- 'joinmarket': JoinMarket CoinJoin\n\n"
