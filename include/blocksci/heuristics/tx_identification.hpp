...
namespace blocksci {
    ...
    namespace heuristics {
        ...
        CoinJoinResult BLOCKSCI_EXPORT isPossibleCoinjoin(const Transaction &tx, int64_t minBaseFee,
        ...
        bool BLOCKSCI_EXPORT isJoinMarketCoinJoin(const Transaction &tx);

        /* Heuristic to find change addresses based on a change in address type.
         @return True if the transaction has one input type and only one output of that same type
         */
        ...
        enum class BLOCKSCI_EXPORT CoinJoinType {
            WW2zkSNACKs,
            WW2PostzkSNACKs,
            WW1,
            Whirlpool,
        ...
        /**
         * Ashigaru CoinJoin detection.
         *
         * Checks basically if it's whirlpool, but from 2025 onwards.
         *
         * @param tx The transaction to check
         *
         * @return true if the transaction is a Ashigaru CoinJoin, false otherwise
         */
        ...
        // consolidation
        enum class BLOCKSCI_EXPORT ConsolidationType { Certain, Possible, None };
