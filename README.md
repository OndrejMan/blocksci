...
3. Build the dependency image by running `docker build --target dependencies -t blocksci-cj .` in the root of the repository. This only installs the toolchain and libraries; it does not compile BlockSci.
